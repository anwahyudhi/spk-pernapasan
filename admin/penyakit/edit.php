...
session_start();
$id = $_GET['kuman'];
$query=mysqli_query($dbh,"select * from penyakit where id_penyakit='$id'");
            ...
            <div id="content">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2>Ubah Data Kriteria <?php echo $data['nama_penyakit'] ?></h2>
                        </div>
                        <div class="panel-body">
                             <div class="col-md-6 col-md-offset-3 text-center">
                                <form class="form" action="edit_proses.php?kuman=<?php echo $data['id_penyakit'] ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                      <label>Nama Penyakit</label>
                                      <input type="text" name="nama" class="form-control" value="<?php echo $data['nama_penyakit'] ?>">
                                    </div>
                                    <div class="form-group">
                                    <label>Keterangan</label>
                                        <textarea name="keterangan" cols="60" rows="10" class="form-control"><?php echo $data['keterangan'] ?>
