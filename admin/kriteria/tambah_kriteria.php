                ...
                <div class="container">
                    <center>
                        ...
                        <div class="panel-heading">
                            <h2>Menambah Data Kriteria</h2>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-6 col-md-offset-3 text-center">
                                <form class="form" action="tambah_proses.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                     	...
                     	<input type="number" name="bobot" class="form-control" step="0.001">
                     </div>
                    <div class="form-group">
