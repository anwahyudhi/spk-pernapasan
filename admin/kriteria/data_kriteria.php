                ...
                <div class="panel panel-default">
                    <center>
                        <div class="panel-heading">
                            <h2>Data Kriteria</h2>
                            <a href="tambah_kriteria.php" class="btn btn-success btn-fill">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_kriteria.php?pohon=<?php echo $data['id_kriteria'] ?>" class="btn btn-warning btn-sm btn-fill btn-block">
                                              <i class="glyphicon glyphicon-pencil"></i>
                                              <span>ubah</span>
                                            </a>   
                                
                                            <a class="btn btn-danger btn-sm btn-fill btn-block" href="hapus_kriteria.php?id=<?php echo $data['id_kriteria'] ?>" onclick="return confirm('Apa anda yakin dengan penghapusan data?');">
