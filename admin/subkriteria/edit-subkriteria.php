                ...
                <div class="container">
                    <center>
                        ...
                        <div class="panel-heading">
                            <h2>Merubah Data Subkriteria <?php echo $data['nama']; ?></h2>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-6 col-md-offset-3 text-center">
                                <form class="form" action="edit-subkriteria-proses.php?subkriteria=<?php echo $data['id_subkriteria'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                     	...
                     	<input type="number" name="bobot" value="<?php echo $data['nilai_subkriteria'] ?>" class="form-control" step="0.001">
                     </div>
                     <div class="form-group">
                      ...
                      <select class="form-control" id="sel1" name="kriteria">
                        ...
                        foreach ($dbh->query($sql1) as $data1) :
                         ?>
                         <<option value="<?php echo $data1['id_kriteria'] ?>"<?php if($data['id_kriteria'] == $data1['id_kriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_kriteria']; ?></option>
                    ...
                    <input type="submit" required name="nanam" value = "Simpan" class="btn btn-success btn-fill pull-left" onclick="return confirm('Apa anda yakin dengan Penambahan data subkriteria?');">
                    </div>
                    </form>
                            </div>
                        </div>
